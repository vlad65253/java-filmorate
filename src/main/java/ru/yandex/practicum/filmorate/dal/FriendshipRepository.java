...
public class FriendshipRepository extends BaseRepository<User>{
    private static final String ADD_FRIEND_QUERY = "INSERT INTO FRIENDS_LIST(USER_ID, FRIEND_ID) " +
            "VALUES(?, ?)";
    private static final String DEL_FRIEND_QUERY = "DELETE FROM FRIEND_LIST(USER_ID, FRIEND_ID) " +
